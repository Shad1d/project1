...
const ProductCard = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 overflow-hidden flex flex-col h-full ${className}`}
    >
      {/* Image */}
      ...
      <div className={`${cardPadding} flex flex-col flex-1`}>
        ...
        {/* Negotiable / Delivery badges slot — keeps consistent height even when absent */}
        <div className="flex items-center gap-1.5 mb-3 min-h-[26px]">
          {product?.negotiable && (
...
export const ProductCardSkeleton = ({
  ...
  <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden animate-pulse flex flex-col h-full">
    <div className={`${imageHeight} bg-gray-200 flex-shrink-0`} />
    <div className={`${cardPadding} flex flex-col flex-1`}>
