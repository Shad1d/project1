...
export default function RegisterPage() {
    ...
    const handleSubmit = () => {
        ...
        alert("Form valid! Check the browser console. (API call added in Step 4)");
    };

    // ── Render ────────────────────────────────────────────────
    return (
        <div className="min-h-screen bg-gradient-to-r from-emerald-50 via-green-100 to-teal-100 flex items-center justify-center p-4">
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div className="p-10 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="h-12 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 rounded-lg flex items-center gap-2 px-5 text-white disabled:opacity-60"
                        >
                            {locationLoading
                                ? "Detecting location…"
                        ...
                        {showMap && (
                            <div className="rounded-xl overflow-hidden border-2 border-emerald-300 shadow-md">
                                {/* Hint strip above the map */}
                                <div className="bg-emerald-50 border-b border-emerald-300 px-4 py-2 text-sm text-emerald-700">
                                    {mapCoords
                ...
                */}
                                ...
                                {mapCoords && (
                                    <div className="bg-emerald-50 border-t border-emerald-200 px-4 py-2 text-xs text-emerald-600">
